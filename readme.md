...
3. If your block is not part of `b-blocks`, then the text domain should be your `plugin-slug`.
...
6. The main element is `.wp-block-b-blocks-{blockname}`, and its immediate child is `.advScrollbarBlockName`. Do not apply width or columns for the main element.
